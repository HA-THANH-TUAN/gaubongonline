          ...
          <div className="w-full">
            <div className="max-w-sm mx-auto bg-zinc-100 pb-12 pt-3 rounded">
              ...
              <form className="sm:mx-5 mx-2">
                ...
                <div className="text-center mt-16"><button type="button" className="bg-orange-500 hover:bg-orange-400 text-white px-2 py-[10px] font-medium rounded">Đăng nhập</button></div>
              </form>
